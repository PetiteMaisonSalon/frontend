...
export default function KontaktPage() {
  return (
    <main className="bg-[#F2F0EB]">
      <section className="w-full px-3 pb-24 pt-8 sm:pt-12 lg:min-h-[calc(100svh-4.75rem)] lg:pb-12 lg:pt-12">
        ...
        <div className="mt-16 flex flex-col lg:mt-20 lg:flex-row lg:items-start lg:justify-between">
          ...
          <figure className="relative mt-12 w-full shrink-0 overflow-hidden bg-[#E6E3DE] lg:mt-36 lg:w-[min(42vw,42rem)] lg:mt-100">
